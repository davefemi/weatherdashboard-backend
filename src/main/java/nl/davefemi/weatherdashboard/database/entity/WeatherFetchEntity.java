...
public class WeatherFetchEntity {
    ...
    private List<WeatherFetchLocationEntity> weatherFetchLocations = new ArrayList<>();

    public void addWeatherFetchLocation(WeatherFetchLocationEntity weatherFetchLocation) {
